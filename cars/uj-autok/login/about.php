...
<div class="dyn-about-con">
	<div class="dyn-about-top">
		<div class="container-fluid">
			
			<div class="about-title">DYNACAR Világa</div>
				<div class="dynceg row">
					<img class="col-12 col-md-5 d-none d-md-block" height="250px" src="../../../images/dyncarceg.png">

					<p class="col-12 col-md-7">

					<span class="dynceg-title">Cég bemutató</span><br><br>
					<span class="dynceg-bemutato">Több éve alakult meg a cégünk amely közvetítője a nagyobb autómárkák járműveinek az eladásában. Minden autó eladás előtt átmegy egy teljesítmény ellenörzésen és folyamatos karbantartás allatt vannak az autók.</span>
					</p>
